...
class PhotoForm(forms.ModelForm):
    ...
    height = forms.FloatField(widget=forms.HiddenInput())
        #afterPoll = forms.IntegerField(widget)
    ...
    def save(self, first, col1, col2):
        ...
        if first == True:
            ...
            plt.title("Processed Image", position=(0.5, 1.0+0.05), fontsize=10)
            ...
            a = skin_color_lab.item(0,0,1)
            b = skin_color_lab.item(0,0,2)

            textstr1 = '\n'.join((
            #r'Dominant Skin Color',
            r'$L = %.2f$' % (skin_color_lab.item(0,0,0), ),
            r'$A = %.2f$' % (skin_color_lab.item(0,0,1), ),
            r'$B = %.2f$' % (skin_color_lab.item(0,0,2), )))
            ...
            if a >= 130 and a <= 138:
                photo.color1 = "summer_cool"
            elif a>=139 and a<=144:
                if b >=130 and b <= 138:
                    photo.color1 = "winter_cool"
                elif b >= 139:
                    photo.color1 = "spring_warm"
                else:
                    photo.color1 = ""
            elif a > 145:
                photo.color1 = "autumn_warm"
            else:
                photo.color1 = ""
